...
- на странице рецепта **состав** выводится **построчно**; ведущее **число/количество** выделено жирным; если название компонента **точно совпадает** с `name` другого рецепта в книге, по клику открывается **его** карточка;
